  ...
  'pt-BR': {
    translation: {
      ...
      gameCard: {
        ...
        edit: 'Editar',
        delete: 'Deletar',
        syncCover: 'Buscar capa',
        invalidDate: 'Data inválida',
      },
      coverSync: {
        title: 'Sincronizar capa',
        close: 'Fechar',
        searching: 'Buscando jogos...',
        loadingCovers: 'Carregando capas...',
        noResults: 'Nenhum jogo encontrado.',
        noCovers: 'Nenhuma capa encontrada.',
        searchError: 'Erro ao buscar jogos.',
        coversError: 'Erro ao carregar capas.',
        selectGame: 'Selecione o jogo correto:',
  ...
  en: {
    translation: {
      ...
      coverSync: {
        ...
        loadingCovers: 'Loading covers...',
        noResults: 'No games found.',
        noCovers: 'No covers found.',
        searchError: 'Error searching games.',
        coversError: 'Error loading covers.',
        selectGame: 'Select the correct game:',
